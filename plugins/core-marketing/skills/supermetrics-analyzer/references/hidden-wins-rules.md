...
- **Why it matters:** the platform isn't spending the budget you allocated. Headroom exists.
- **Likely cause:** audience too narrow, bid cap too tight, or creative not winning enough auctions despite high efficiency.
...
- **Why it matters:** almost always a tracking outage, a pixel/SDK issue, or a CAPI hiccup — not a real performance drop. Treating it as performance means pausing a working campaign.
